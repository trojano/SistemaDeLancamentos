...
public class TelaResultados extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Município", "Nome", "Responsável", "Gênero", "Banco", "Agência", "Conta", "CPF / CNPJ", "Cor / Raça", "LGBTQI+", "E-mail", "Telefone", "Valor Repasse", "Data Repasse", "Teto de gastos do Mun.", "Nro de eleitores"
            }
        ));
